...
/*
//My Listener class which determine the shape ID
class MyListener : public pcl::PointXYZ
{

public:

  void callThreafFunc(const pcl::PointXYZ *data, int myShape)
  {
...
///////////////////////////////////////////////////////////////////////////////
//The PCL objects which will be used to calculate the dimensions of the objects
//////////////////////////////////////////////////////////////////////////////
/*
      // PCL objects
...
/*
     ...
     time.tic();
      ...
      /////////////////////////////////////////////////////////////////////////////////////////////
      //A switch case that creates segmentation models for each shape, and describes the parameters
      ////////////////////////////////////////////////////////////////////////////////////////////
      switch (myShape) {
...
/*
// YA YA YA
  void onNewData(const pcl::PointXYZ *data)
  {
...
/*
  pcl::PointCloud<pcl::PointXYZ>::Ptr MyListener::points_to_pcl(const PointXYZ* data)
  {
      pcl::PointCloud<pcl::PointXYZ>::Ptr cloud(new pcl::PointCloud<pcl::PointXYZ>);
...
/*
    std::cout << "Yahooooooooo " <<plane_max[2][1] << std::endl;
    std::cout << "Yahooooooooo " <<plane_min[2][1] << std::endl;
    std::cout << "Yahooooooooo " <<plane_max[2][2] << std::endl;
    std::cout << "Yahooooooooo " <<plane_min[2][2] << std::endl;
    std::cout << "Yahooooooooo " <<plane_max[2][3] << std::endl;
    std::cout << "Yahooooooooo " <<plane_min[2][3] << std::endl;


    double plane_offshootx = plane_min[1][1]-plane_max[2][1];
    double plane_offshootz = plane_min[1][3]-plane_max[2][3];
    std::cout << "Awesome dude " <<plane_offshoot << std::endl;

    if (plane_offshootx < 0.05){
        if (plane_offshootz < 0.05){

      double newpboxheigth = plane_max[1][2] - plane_min[2][2];
      double newboxwidth = plane_max[2][1] - plane_min[2][1];
      double newboxdepth = plane_max[1][1] - plane_min[1][1];

      std::cout << "Box height " <<newpboxheigth << std::endl;
        std::cout << "Box width " <<newboxwidth << std::endl;
          std::cout << "Box depth " <<newboxdepth << std::endl;
}
else{

  std::cout <<" Planes were too far apart " << std::endl;
}
    }
    else{
...
/*
pcl::PointCloud<pcl::PointXYZ>::Ptr yes(new pcl::PointCloud<pcl::PointXYZ>);
Eigen::Matrix3f covariance_matrix;

Eigen::Vector4f xyz_centroid;

compute3DCentroid (*yes, xyz_centroid);

computeCovarianceMatrix (*yes, xyz_centroid, covariance_matrix);
...
//Eigen::Vector4f plane_parameters = {0,0,0,0};
//float curvature = 0;




//computePointNormal (const pcl::PointCloud<PointInT> &yes, const std::vector<int> &indices, Eigen::Vector4f &plane_parameters, float &curvature);
//computePointNormal (yes, indices, plane_parameters, curvature);
...
compute3DCentroid (plane0, xyz_centroid);

computeCovarianceMatrix (plane0, xyz_centroid, covariance_matrix)
*/

/*
int plane_dotProduct;
int boxDim1.str();
int b;

        std::stringstream boxDim1;
      //  boxDim1 << myShape << "-" << b << "; dotProduct: " << plane_dotProduct << " ; plane_1 lenght: " << plane1_length << " ; plane_2 length: " << plane2_length << " ; before_aCos: " << before_aSin << "; angle C: " << c_angle << std::endl;
